...
if ?x then (x+x) + next x else 1
    ...
    If statements also require delay compensation, this time across 3 different operands. Otherwise, we just recursively allocate space for the operands as usual.
