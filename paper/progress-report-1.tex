...
z where
    ...
    \end{lstlisting}
    \lstinline{fib} must have a 2-cell buffer, references access it at 2 distinct points in time.

    % The algorithm for computing the offsets is as follows: First, traverse the tree, 
    % building and 
